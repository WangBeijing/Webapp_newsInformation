/*! wangeditor.js 2016-09-25 */ ! function(a) {
		...
		a.createMenu(function(b) {
			...
			if(b(d)) {
				...
				m.clickEvent = function(b) {
					...
					var i, k = h.height(),
						m = h.outerHeight();
					g.useMaxHeight && (f = h.css("max-height"), h.css("max-height", "none"),
						i = h.parent(), i.after(h), i.remove(), h.css("overflow-y", "auto"));
		...
		a.plugin(function() {
			...
			c.onload || (c.onload = function(b, c) {
				...
				0 === b.indexOf("error|") ? (a.warn("上传失败：" + b.split("|")[1]), alert(b.split("|")[1])) : (a.log("上传成功，即将插入编辑区域，结果为：" + b), d = document.createElement("img"), d.onload = function() {
					var c = '<img src="http://'+window.location.host + b + '" alt="' + f + '" style="max-width:100%;"/>';
